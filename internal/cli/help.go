...
func PrintHelp() {
	...
	fmt.Println("  protection start|stop   Start/stop per-terminal protected recording (recorder)")
	fmt.Println("  redact [N]     Rebuild view keeping last N prompts raw (others redacted); requires protection")
	...
	fmt.Println("  config         Show configuration (e.g. config redaction)")
	fmt.Println("  help           Show this help message")
	fmt.Println()
	fmt.Println("Examples:")
	fmt.Println("  blastradius start")
	fmt.Println("  blastradius status --json")
	fmt.Println("  blastradius protection start")
	fmt.Println("  blastradius redact 0")
	fmt.Println("  blastradius protection stop")
	fmt.Println()
